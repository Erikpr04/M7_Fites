...
<h1>Filtrar per habitants</h1>
	<form action="ex3_1.php" method="POST">
		...
		<input type="number" name="min_habitants" id="min_habitants"  value="0">

		<label for="max_habitants">Maxim de habitants:</label>
		<input type="number" name="max_habitants" id="max_habitants"  value="100">
...
if(isset($_POST["min_habitants"]) && isset($_POST["max_habitants"])) {
		...
		$max_habitants = $_POST["max_habitants"];
 		...
 		$consulta = "SELECT Name, CountryCode, District, Population FROM city WHERE Population BETWEEN $min_habitants AND $max_habitants ORDER BY population DESC;";
